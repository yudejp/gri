module GRI
  DEFS = {
    ...
    :term => {
      :default=>[['日次', 30*3600], ['週次', 8*24*3600],
        ['月次', 31*24*3600], ['年次', 365*24*3600]],
      :short=>[['直近 3 時間', 3*3600], ['日次', 30*3600],
        ['週次', 8*24*3600], ['月次', 31*24*3600]],
      :long=>[['週次', 8*24*3600], ['月次', 31*24*3600],
        ['年次', 365*24*3600], ['直近 6 年', 6*365*24*3600]],
      :verylong=>[['月次', 31*24*3600], ['年次', 365*24*3600],
        ['直近 8 年', 8*365*24*3600]],
    }
  }
